...
export declare const type: (v?: "string" | "number" | "boolean" | "array" | "count") => PropertyDecorator, description: (v?: string) => PropertyDecorator, demand: (v?: string | boolean) => PropertyDecorator, alias: (v?: string | readonly string[]) => PropertyDecorator, choices: (v?: import("yargs").Choices) => PropertyDecorator, coerce: (v?: (arg: any) => any) => PropertyDecorator, configParser: (v?: (configPath: string) => object) => PropertyDecorator, conflicts: (v?: string | readonly string[] | {
