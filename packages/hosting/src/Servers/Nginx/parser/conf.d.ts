...
import { Name, NginxParseTreeNode } from './parser';
...
interface NginxConfItemProps<K extends keyof types.AllDirectives = any> {
    _name: Name;
    _value: types.AllDirectives[K];
    _root?: boolean;
    _comments: string[];
    _isVerbatim: boolean;
    __isBlock: boolean;
...
export declare const createConfItem: (file: NginxConfFile, target: IndexableConfItem, node: NginxParseTreeNode, isRoot?: boolean) => NginxConfItem;
