...
exports.NginxConfFile = exports.createConfItem = void 0;
...
const createConfItem = (file, target, node, isRoot = false) => {
    ...
    const newContext = {
        ...
        _add: function (name, value, children, comments, options = {}) {
            ...
            const item = newContext;
            const node = (0, exports.createConfItem)(file, item, {
                name: name,
    ...
    if (children) {
        for (let i = 0; i < children.length; i++) {
            (0, exports.createConfItem)(file, item, children[i]);
        }
    }
    return item;
};
exports.createConfItem = createConfItem;
class NginxConfFile extends events.EventEmitter {
    constructor(tree, options = {}) {
        ...
        this.nginx = (0, exports.createConfItem)(this, this, {
            name: 'nginx',
            children: null,
            comments: [],
            isBlock: false,
        ...
        for (let i = 0; i < children.length; i++) {
            ...
            (0, exports.createConfItem)(this, this.nginx, node);
        }
    }
    live(file) {
