export namespace types {
    export type Context = "events" | "main" | "http" | "mail" | "stream" | "server" | "location" | "any" | "if in location" | "limit_except" | "if" | "upstream"
    export interface MainDirectives {
        /**
    ...
    export interface EventsDirectives {
        /**
         * Determines whether nginx should become a daemon.
         * Mainly used during development.
         *
    ...
    export interface MailDirectives {
        /**
         * Determines whether nginx should become a daemon.
         * Mainly used during development.
         *
    ...
    export interface StreamDirectives {
        /**
         * Determines whether nginx should become a daemon.
         * Mainly used during development.
         *
    ...
    export interface AllDirectives extends MainDirectives,EventsDirectives,HttpDirectives,StreamDirectives {}
}
