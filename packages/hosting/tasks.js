    ...
    'dts:replace': async () => {
        replacers({
            ...
            files    : [{
                ...
                replacers: ['HostingServiceProvider']
            }],
            replacers: {
                HostingServiceProvider: ['/// <reference types="types/HostingServiceProvider" />', '/// <reference path="./HostingServiceProvider.d.ts" />']
            }
        });
    }
});
