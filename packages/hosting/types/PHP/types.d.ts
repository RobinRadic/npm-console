...
export declare type PhpExtensionName = keyof PhpExtensionInis | string;
export declare namespace php_ini {
...
export declare namespace php_inis {
    interface PhpExtensionIni {
        extension?: string;
        zend_extension?: string;
        [key: string]: any;
    }
    interface PhpExtensionInis {
