[@radic/core](../README.md) / ArrayCollection

# Class: ArrayCollection<Type\>
...
- [constructor](ArrayCollection.md#constructor)

### Properties

- [length](ArrayCollection.md#length)
- [[species]](ArrayCollection.md#[species])

### Methods

- [[iterator]](ArrayCollection.md#[iterator])
- [[unscopables]](ArrayCollection.md#[unscopables])
- [at](ArrayCollection.md#at)
- [concat](ArrayCollection.md#concat)
- [copyWithin](ArrayCollection.md#copywithin)
- [entries](ArrayCollection.md#entries)
- [every](ArrayCollection.md#every)
- [fill](ArrayCollection.md#fill)
- [filter](ArrayCollection.md#filter)
- [find](ArrayCollection.md#find)
- [findIndex](ArrayCollection.md#findindex)
- [flat](ArrayCollection.md#flat)
- [flatMap](ArrayCollection.md#flatmap)
- [forEach](ArrayCollection.md#foreach)
- [includes](ArrayCollection.md#includes)
- [indexOf](ArrayCollection.md#indexof)
- [join](ArrayCollection.md#join)
- [keys](ArrayCollection.md#keys)
- [lastIndexOf](ArrayCollection.md#lastindexof)
- [map](ArrayCollection.md#map)
- [pop](ArrayCollection.md#pop)
- [push](ArrayCollection.md#push)
- [reduce](ArrayCollection.md#reduce)
- [reduceRight](ArrayCollection.md#reduceright)
- [reverse](ArrayCollection.md#reverse)
- [shift](ArrayCollection.md#shift)
- [slice](ArrayCollection.md#slice)
- [some](ArrayCollection.md#some)
- [sort](ArrayCollection.md#sort)
- [splice](ArrayCollection.md#splice)
- [toLocaleString](ArrayCollection.md#tolocalestring)
- [toString](ArrayCollection.md#tostring)
- [unshift](ArrayCollection.md#unshift)
- [values](ArrayCollection.md#values)
- [from](ArrayCollection.md#from)
- [isArray](ArrayCollection.md#isarray)
- [of](ArrayCollection.md#of)

## Constructors

### constructor

• **new ArrayCollection**<`Type`\>(...`items`)
...
▸ **copyWithin**(`target`, `start`, `end?`): [`ArrayCollection`](ArrayCollection.md)<`Type`\>
...
[`ArrayCollection`](ArrayCollection.md)<`Type`\>
...
▸ **fill**(`value`, `start?`, `end?`): [`ArrayCollection`](ArrayCollection.md)<`Type`\>
...
▸ **sort**(`compareFn?`): [`ArrayCollection`](ArrayCollection.md)<`Type`\>
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `compareFn?` | (`a`: `Type`, `b`: `Type`) => `number` | Function used to determine the order of the elements. It is expected to return a negative value if the first argument is less than the second argument, zero if they're equal, and a positive value otherwise. If omitted, the elements are sorted in ascending, ASCII character order. ```ts [11,2,22,1].sort((a, b) => a - b) ``` |
